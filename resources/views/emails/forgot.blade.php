            ...
            <table>
                <tr>
                    <td class="table-td-wrap" align="center" width="458">
                                                ...
                                                <table class="header-row" width="378" cellspacing="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        <td class="header-row-td" width="378"
                                                            ...
                                                            valign="top" align="left">Hi {{ $name }},
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
                                                    <b style="color: #777777;">You recently requested to reset your password for your account.</b>
                                                    <br>
                                    ...
                                    <table class="table-col" align="left" width="378" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td class="table-col-td" width="378"
                                                ...
                                                valign="top" align="left">
                                                <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
                                                    <b style="color: #777777;">If you did not request a password reset, secure your account by changing your password now.</b>
                                                </div>
                                            </td>
                                        </tr>
                                        </tbody>
                                    ...
                                    <table class="table-col" align="left" width="378" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td class="table-col-td" width="378"
                                                ...
                                                valign="top" align="left">
                                                <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
                                                    <b style="color: #003366;">Thanks,<br>{{ env('APP_NAME') }}</b>
                                                </div>
                                            </td>
                                        </tr>
                                        </tbody>
                        ...
                        <table class="table-space" height="12"
                            ...
                            <tr>
                                <td class="table-space-td" valign="middle" height="12"
                                    ...
                                    width="450" bgcolor="#FFFFFF" align="center">&nbsp;<table bgcolor="#E8E8E8"
                                                                                              height="0" width="100%"
                                                                                              cellspacing="0"
                                                                                              cellpadding="0"
                                                                                              border="0">
                                    ...
                                    <table class="table-col" align="left" width="378" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td class="table-col-td" width="378"
                                                style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;"
                                                valign="top" align="left">
                                                <div style="font-family: Arial, sans-serif; line-height: 15px; color: #444444; font-size: 11px;">
                                                    If you are having trouble clicking the password reset button, copy and paste the URL below into your web browser.
                                                    <br><br>
                                                    {{ $url }}
                                                </div>
                                            </td>
                        ...
                        <table class="table-space" height="12"
                               style="height: 20px; font-size: 0px; line-height: 0; width: 450px; background-color: #ffffff;"
                               width="450" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0" border="0">
                            <tbody>
                            <tr>
                                <td class="table-space-td" valign="middle" height="6"
                                    style="height: 20px; width: 450px; background-color: #ffffff;" width="450"
                                    bgcolor="#FFFFFF" align="left">&nbsp;
                                </td>
                            </tr>
                            </tbody>
